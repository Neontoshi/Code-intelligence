// src/analysis/layers/go.rs

//! Go-specific layer detection

use crate::analysis::layers::{LayerDetector, LayerInfo};
use crate::parser::tree_sitter::ParsedFile;
use std::collections::HashMap;

pub struct GoLayerDetector;

impl LayerDetector for GoLayerDetector {
    ...
    fn get_layer_info(&self) -> HashMap<String, LayerInfo> {
        ...
        info.insert(
            ...
            LayerInfo {
                ...
                description: "Data access and repositories".to_string(),
        ...
        info.insert(
            ...
            LayerInfo {
                ...
                description: "Internal packages (not exported)".to_string(),
                color: "#64748b".to_string(),
            },
        );
        ...
        info.insert(
            ...
            LayerInfo {
                ...
                description: "Public package code".to_string(),
